...
<div class="users" >
  <div class="con">
    ...
    <div class="pagination">
        <?php
        if ($page > 1) {
            echo "<a href='bags.php?page=" . ($page - 1) . "'>&laquo; Previous</a>";
        }

        for ($i = 1; $i <= $total_pages; $i++) {
            if ($i == $page) {
                echo "<a class='active' href='bags.php?page=" . $i . "'>" . $i . "</a>";
            } else {
                echo "<a href='bags.php?page=" . $i . "'>" . $i . "</a>";
            }
        }

        if ($page < $total_pages) {
            echo "<a href='bags.php?page=" . ($page + 1) . "'>Next &raquo;</a>";
        }
        ?>
    </div>
    <button class="Update" style="width: 120px;"><a href="./add_bags.php">Add BAG</a></button>
